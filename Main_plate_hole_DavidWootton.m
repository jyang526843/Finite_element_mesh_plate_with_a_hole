...
%X = [X1 ;X2(m:-1:1,:)] ;      % Merge both the domains, original code
%Y = [Y1 ;Y2(m:-1:1,:)] ;
X = [X1; Y1(m-1:-1:1,:)];       % Merge domain 1 with its mirror image
Y = [Y1; X1(m-1:-1:1,:)];       %   around x = y (or theta = pi/4) line
